  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white font-sans p-4 sm:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        {/* Replicating the main app header for visual consistency */}
        ...
        {/* Re-styled paywall content to match the app's main panel */}
        <main className="max-w-lg mx-auto bg-gray-800/50 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-gray-700 text-center">
            ...
            <a
                href="https://buy.stripe.com/test_8x23cvbiLdbOgsuflV5Vu00" // IMPORTANT: This is now your functional test link.
                target="_blank"
